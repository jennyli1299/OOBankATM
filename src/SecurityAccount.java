...
public class SecurityAccount extends Account {
    ...
    public SecurityAccount(String IBAN, Float balanceInLocalCurrency, int routingNumber, int accountNumber, boolean active, Currency currency) {
        super(IBAN, 0f, routingNumber, accountNumber, active, new Currency("USD"));
